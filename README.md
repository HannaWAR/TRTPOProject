...
2. [Требования пользователя](#user_requirements)
    + [Программные интерфейсы](#software_interfaces)
    + [Интерфейс пользователя](#user_interface)
    + [Характеристики пользователей](#user_specifications)
        + [Классы пользователей](#user_classes)
        + [Аудитория приложения](#application_audience)
            + [Целевая аудитория](#target_audience)
    + [Предположения и зависимости](#assumptions_and_dependencies)
3. [Системные требования](#system_requirements)
    + [Функциональные требования](#functional_requirements)
        + [Основные функции](#main_functions)
            + [Ввод данных](#input_data)
            + [Отправка на сервер](#send_to_server)
            + [Получение информации](#get_info)
            + [Подтверждение окончания загрузки/выгрузки](#finish_work)
        + [Ограничения и исключения](#restrictions_and_exclusions)
    + [Нефункциональные требования](#non-functional_requirements)
        + [Атрибуты качества](#quality_attributes)
            + [Требования к удобству использования](#requirements_for_ease_of_use)
            + [Требования к безопасности](#security_requirements)
        + [Внешние интерфейсы](#external_interfaces)
